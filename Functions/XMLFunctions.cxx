...
std::string calibrateModelFromSetupFile(const std::string& IMUPlacerSetupFile, const OpenSim::TimeSeriesTable_<SimTK::Quaternion>& quaternionTimeSeriesTable)
{
	...
	std::cout << IMUPlacerSetupFile << std::endl;

	std::cout << quaternionTimeSeriesTable << std::endl;
	std::cout << "Trying to run IMUPlacer!" << std::endl;
...
OpenSim::TimeSeriesTable_<SimTK::Quaternion> quaternionTableFromTextFile(std::string quatFileName) {
	...
	std::cout << "Reading from: " << OPENSIMLIVE_ROOT + "/OpenSimLive-results/" + quatFileName;
...
std::string calibrateModel(OpenSim::TimeSeriesTable_<SimTK::Quaternion>& quatTable, double& calibTime)
{
	...
	std::cout << OPENSIMLIVE_ROOT + "/Config/" + ConfigReader("MainConfiguration.xml", "imu_placer_setup_file") << std::endl;
	system("pause");
